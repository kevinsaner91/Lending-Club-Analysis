...
# further filter based on this: - would be correct from the business perspective but not performed based on task description
...
for( i in 1:ncol(df_loan)){
  jpeg(file=paste("plots/NN04/Relationship between loan status and ", variables[i],".jpeg"),width=1920, height=1200)
  ...
  jpeg(file=paste("plots/NN04/Inverted Relationship between loan status and ", variables[i],".jpeg"),width=1920, height=1200)
